        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <div class="collapse" id="journalSubmenu" data-bs-dismiss="offcanvas">
                    <a href="?tb=7" data-bs-target="#transcript" class="list-group-item list-group-item-action bs-light session-active tabShow" aria-expanded="false" role="tab" data-bs-toggle="tab" aria-controls="subitem1">Transcript</a>
                    <a href="?tb=8" data-bs-target="#minutes" class="list-group-item list-group-item-action bs-light session-active tabShow" aria-expanded="false" role="tab" data-bs-toggle="tab" aria-controls="subitem1">Minutes</a>
